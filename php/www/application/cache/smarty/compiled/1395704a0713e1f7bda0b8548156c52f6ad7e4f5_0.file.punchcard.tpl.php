<?php
/* Smarty version 3.1.31, created on 2017-04-14 16:12:39
  from "/home/www/application/views/default/admin/activity/punchcard.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_58f08477869b24_54532961',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1395704a0713e1f7bda0b8548156c52f6ad7e4f5' => 
    array (
      0 => '/home/www/application/views/default/admin/activity/punchcard.tpl',
      1 => 1492157555,
      2 => 'file',
    ),
  ),
...
function content_58f08477869b24_54532961 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_53340940258f08477856044_35866276', 'javascript');
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_110264912758f0847785ac68_07988541', 'body');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "mainlayout.tpl");
}
/* {block 'javascript'} */
class Block_53340940258f08477856044_35866276 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'javascript' => 
  array (
    0 => 'Block_53340940258f08477856044_35866276',
  ),
);
...
/* {/block 'javascript'} */
/* {block 'body'} */
class Block_110264912758f0847785ac68_07988541 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'body' => 
  array (
    0 => 'Block_110264912758f0847785ac68_07988541',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
    ...
    <div class="admin-main">
        <blockquote id='searchform' class="layui-elem-quote">
            ...
            <form class="layui-form" action="<?php echo site_url('activity/punchCard');?>
" method="get">
                <div>
                    <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['aid']->value;?>
" autocomplete="off" class="layui-input" placeholder="">
                    <input type="hidden" name="act" value="<?php echo $_smarty_tpl->tpl_vars['act']->value;?>
" autocomplete="off" class="layui-input" placeholder="">
                    <?php if ((string)$_smarty_tpl->tpl_vars['act']->value === 'clock') {?>
                        <div class="layui-input-inline">
                            <input type="text" name="keyword" value="<?php echo $_smarty_tpl->tpl_vars['keyword']->value;?>
" autocomplete="off" class="layui-input" placeholder="打卡人">
                        </div>
                    <?php } else { ?>
                        <div class="layui-input-inline">
...
?>
                            <tr>
                                ...
                                <?php if ((string)$_smarty_tpl->tpl_vars['act']->value === 'clock') {?>
                                    ...
                                    <td>
                                        <?php if ((int)$_smarty_tpl->tpl_vars['row']->value['type'] === 1) {?>
                                            管理员扫普通用户
                                        <?php } elseif ((int)$_smarty_tpl->tpl_vars['row']->value['type'] === 2) {?>
                                            委员代打
                                        <?php } else { ?>
                                            用户扫二维码
                                        <?php }?>
                                ...
                                <?php } else { ?>
                                    ...
                                    <td>
                                        <?php echo $_smarty_tpl->tpl_vars['row']->value['usertel'];?>
                                    ...
                                    <td><?php echo $_smarty_tpl->tpl_vars['row']->value['beizhu'];?>
</td>   
                                <?php }?>
