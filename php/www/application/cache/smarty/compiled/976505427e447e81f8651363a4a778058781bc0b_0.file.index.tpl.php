<?php
/* Smarty version 3.1.31, created on 2017-01-23 17:06:11
  from "/home/www/application/views/default/admin/zone/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5885c783642846_01899009',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '976505427e447e81f8651363a4a778058781bc0b' => 
    array (
      0 => '/home/www/application/views/default/admin/zone/index.tpl',
      1 => 1485162366,
      2 => 'file',
    ),
  ),
...
function content_5885c783642846_01899009 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_18859203435885c783623d78_20406817', 'javascript');
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_2773145365885c78362dcc8_29021417', 'body');
$_smarty_tpl->inheritance->endChild($_smarty_tpl, "mainlayout.tpl");
}
/* {block 'javascript'} */
class Block_18859203435885c783623d78_20406817 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'javascript' => 
  array (
    0 => 'Block_18859203435885c783623d78_20406817',
  ),
);
        ...
        <?php }?>
            ...
            $('#deletes').on('click', function (event) {
                ...
                parent.layer.confirm('你确定要删除已选择的吗？', {
                    ...
                    $.post('<?php echo site_url('zone/deletezones');?>
...
/* {/block 'javascript'} */
/* {block 'body'} */
class Block_2773145365885c78362dcc8_29021417 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'body' => 
  array (
    0 => 'Block_2773145365885c78362dcc8_29021417',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
    ...
    <div class="admin-main">
        <blockquote id='searchform' class="layui-elem-quote">
            ...
            <form class="layui-form" action="<?php echo site_url('zone/index');?>
" method="get">
                <div>
...
"></td>
                                    ...
                                    <td><a href="<?php echo site_url('zone/comments/');?>
?id=<?php echo $_smarty_tpl->tpl_vars['row']->value['id'];?>
">查看 [<?php echo $_smarty_tpl->tpl_vars['row']->value['comments'];?>
]</a></td>
                                    <td><a href="<?php echo site_url('zone/praises/');?>
?id=<?php echo $_smarty_tpl->tpl_vars['row']->value['id'];?>
">查看 [<?php echo $_smarty_tpl->tpl_vars['row']->value['praises'];?>
]</a></td>
                                    <td align="center">
                                        <a href="<?php echo site_url('zone/deletezone/');
