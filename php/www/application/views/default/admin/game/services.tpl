...
{block name=body}
    <div class="admin-main">
        ...
        <blockquote id='searchform' class="layui-elem-quote">
            ...
            <form class="layui-form" action="{site_url('game/services')}" method="get">
                <input type="hidden" name="pid" value="{$pid}" />
                <div>
                   
                    <div class="layui-inline">
                        <a href="{site_url('game/servicesadd')}?pid={$pid}" class="layui-btn"><i class="fa fa-plus"></i> 新增区服</a>
                    </div>
                </div>
            </form>
                            ...
                            {foreach $list as $row}
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="{site_url('game/servicesedit/')}{$row.id}?pid={$pid}"  class="layui-btn layui-btn-mini"><i class="fa fa-edit" aria-hidden="true"></i> 更新</a>
                                    </td>
                                </tr>
