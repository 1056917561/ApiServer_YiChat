...
{block name=body}
    <div class="admin-main">
        ...
        <blockquote id='searchform' class="layui-elem-quote">
            ...
            <form class="layui-form" action="{site_url('game/channel')}" method="get">
                <input type="hidden" name="pid" value="{$pid}" />
                <div>
                    
                    <div class="layui-inline">
                        <a href="{site_url('game/channeladd')}?pid={$pid}" class="layui-btn"><i class="fa fa-plus"></i> 新增下载渠道</a>
                    </div>
                </div>
            </form>
                        ...
                        <tbody>
                            {foreach $list as $row}
                                <tr>
                                    ...
                                    <td>{$row.name}</td>
                                    <td>{$row.game}</td>
                                    <td><a href="{site_url('game/services/')}?pid={$row.id}">查看区服 {$row.services}</a></td>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="{site_url('game/channeledit/')}{$row.id}?pid={$pid}"  class="layui-btn layui-btn-mini"><i class="fa fa-edit" aria-hidden="true"></i> 更新</a>
                                    </td>
                                </tr>
