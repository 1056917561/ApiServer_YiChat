            ...
            <form class="layui-form" action="" method="post">
                <div>
                    <div class="layui-input-inline">
                        <input type="text" name="name" value="{$edit.name}" autocomplete="off" class="layui-input" placeholder="增加活动类型">
                    </div>
                    <div class="layui-inline">
                        <button class="layui-btn" lay-submit="" lay-filter="demo1"><i class="layui-icon">&#xe62a;</i> 提交</button>
                        {if $edit.name}
                            <a href="{site_url('users/activitytype')}" class="layui-btn"><i class="fa fa-remove" aria-hidden="true"></i> 取消</a>
                        {/if}
                    </div>
                </div>
            </form>
                        ...
                        {foreach $list as $row}
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="{site_url('users/deleteactivity_type/')}{$row.id}" data-confirm="你确定要删除吗？" class="layui-btn layui-btn-danger layui-btn-mini"><i class="fa fa-remove" aria-hidden="true"></i> 删除</a>
                                </td>
                            </tr>
                        {/foreach}
                    </tbody>
