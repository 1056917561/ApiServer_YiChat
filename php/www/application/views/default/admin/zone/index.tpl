        ...
        {/if}
            ...
            $('#deletes').on('click', function (event) {
                ...
                parent.layer.confirm('你确定要删除已选择的吗？', {
                    ...
                    $.post('{site_url('zone/deletezones')}', $('#formdel').serializeArray(),
                            function (data) {
...
{block name=body}
    <div class="admin-main">
        <blockquote id='searchform' class="layui-elem-quote">
            ...
            <form class="layui-form" action="{site_url('zone/index')}" method="get">
                <div>
                        ...
                        <tbody>
                            {foreach $list as $row}
                                <tr>
                                    ...
                                    <td>{$row.time}</td>
                                    <td><a href="{site_url('zone/comments/')}?id={$row.id}">查看 [{$row.comments}]</a></td>
                                    <td><a href="{site_url('zone/praises/')}?id={$row.id}">查看 [{$row.praises}]</a></td>
                                    <td align="center">
