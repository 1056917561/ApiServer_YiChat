        ...
        {/if}
            $('#deletes').on('click', function (event) {
                ...
                parent.layer.confirm('你确定要删除已选择的吗？', {
                    ...
                    $.post('{site_url('zone/deletespraises')}', $('#formdel').serializeArray(),
                            function (data) {
...
{block name=body}
    <div class="admin-main">
        <blockquote id='searchform' class="layui-elem-quote">
            ...
            <form class="layui-form" action="{site_url('zone/praises')}" method="get">
                <div>
                        ...
                        <tbody>
                            {foreach $list as $row}
                                <tr>
                                    ...
                                    <td>{$row.time}</td>
                                    <td align="center">
                                        <a href="{site_url('zone/deletepraises/')}{$row.id}" data-confirm="你确定要删除吗？" class="layui-btn layui-btn-danger layui-btn-mini"><i class="fa fa-remove" aria-hidden="true"></i> 删除</a>
                                    </td>
                                </tr>
                            {/foreach}
                        </tbody>
